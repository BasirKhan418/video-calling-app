...
const Home = () => {
  ...
  return (
    ...
    <div className='flex justify-center items-center flex-col'>
        ...
        <p className='text-blue-600 font-semibold mt-6'>Welcome to the dsw's peer to peer video calling app.</p>
        <p className='text-blue-400 font-light text-center'>Implemente in pure webrtc(Web Real Time Communication).</p>
    </div>
